...
async def coingecko_async_task():
    ...
    async with aiohttp.ClientSession() as session:
        ...
        if page_range < 3:
            ...
            # On profite qu'on ne fait que peu d'appels vers coingecko pour mettre à jour la liste dtao
            await fetch_cg_ids_on_coingecko_async_task()
    ...
    print(f'Tâche coingecko réussie (page {page_range}).')
